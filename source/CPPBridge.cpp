...
void bridge(void * CmdProcessorHandle) {
	...
	accWriter = new io::DataWriter(acc, sd, periph::Interrupt::BMA280_NEW_DATA, true);
	micWriter = new io::DataWriter(mic, sd, periph::Interrupt::AKU340_NEW_DATA, true);
	printf("Try Building tesks\n");
    const char *pcTextForTask1 = "Sensor Task";
    ...
    const char *pcTextForTask2 = "SD Task";
